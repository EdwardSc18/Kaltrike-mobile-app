...
class DriverAboutScreen extends StatefulWidget {
  const DriverAboutScreen({super.key});

  @override
  State<DriverAboutScreen> createState() => _DriverAboutScreenState();
}

class _DriverAboutScreenState extends State<DriverAboutScreen> {
        ...
        child: Column(
          children: [
            ...
            _buildInfoCard(
              ...
              content: "Kaltrike Driver Mobile Application\n\n"
            ...
            _buildInfoCard(
              ...
              content: "Professional tools for driver partners",
              children: [
                _buildFeatureItem("Real-time ride requests"),
                _buildFeatureItem("Earnings tracking & analytics"),
                _buildFeatureItem("Passenger ratings & feedback"),
                _buildFeatureItem("Route optimization"),
              ],
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildDetailRow("Platform", "Driver"),
                ],
              ),
            ),
