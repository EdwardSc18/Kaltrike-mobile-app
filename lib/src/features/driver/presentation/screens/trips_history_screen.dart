...
import 'package:kaltrike_driver_app/src/features/driver/presentation/widgets/history_design_ui.dart';
...
class _TripsHistoryScreenState extends State<TripsHistoryScreen> {
  ...
  Future<void> _refreshTripHistory() async {
    ...
    try {
      // Refresh driver earnings and trip history
                    ...
                    child: Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            "${sortedTripsHistory.length} ${sortedTripsHistory.length == 1 ? 'trip' : 'trips'}",
                            style: const TextStyle(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const SizedBox(width: 8),
                        Text(
                          _isRefreshing ? "Refreshing..." : "Refresh History",
                          style: const TextStyle(
                            color: Colors.white,
                            fontSize: 16,
                            fontWeight: FontWeight.w600,
